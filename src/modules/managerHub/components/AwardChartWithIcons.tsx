...
const AwardChartWithIcons = ({ chartData, timePeriod }: any) => {
const chartLabels = useMemo(() => {
  ...
  const groupedData = chartData.reduce((acc: any, employee: any) => {
    const { employee_id, period, employee_name, employeePhoto, total_awards } =
      employee;
    ...
    acc[employee_id].monthlyBadges[monthIndex] += parseInt(total_awards, 10);
    return acc;
  }, {});
...
export default AwardChartWithIcons;
