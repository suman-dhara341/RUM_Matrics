...
const RecognitionChartWithIcons = ({ chartData, timePeriod }: any) => {
const chartLabels = useMemo(() => {
  ...
  const groupedData = chartData.reduce((acc: any, employee: any) => {
    const { employee_id, period, employee_name, employeePhoto, total_recognitions } =
      employee;
    ...
    acc[employee_id].monthlyBadges[monthIndex] += parseInt(total_recognitions, 10);
    return acc;
  }, {});
...
export default RecognitionChartWithIcons;
