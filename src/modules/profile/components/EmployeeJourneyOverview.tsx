...
import EmployeeJourneyOverviewShimmer from "./shimmer/EmployeeJourneyOverviewShimmer";

const EmployeeJourneyOverview = () => {
  ...
  if (employeeJourneyIsLoading) {
    return <EmployeeJourneyOverviewShimmer />;
  }
  ...
  return (
    <div>
      {employeeJourney?.data?.length ? (
        <div
          className="min-h-[15vh] bg-white rounded-md mb-3 border-1 border-[#E8E8EC] overflow-hidden"
          style={{ boxShadow: "rgba(0, 0, 0, 0.1) 0px 1px 4px" }}
        >
              ...
              <div className="space-y-8">
                {[...(employeeJourney?.data ?? [])]
                  ...
                  .map((journey, index) => {
                    ...
                    const isLast = index === employeeJourney?.data?.length - 1;
                          ...
                          {journey && (
                            <div className="mb-2">
                              <div className="flex gap-2 items-center">
                                {journey.designation && (
                                  <p className="!text-[#585DF9] text-base font-semibold !leading-[0px]">
                                    {journey.designation}
                                  </p>
                                )}
                                {journey.startDate && journey.endDate && (
                                  <p className="text-[#73737D] text-sm leading-[22px]">
                                    {journey.startDate
                                      ? `(${
...
export default EmployeeJourneyOverview;
