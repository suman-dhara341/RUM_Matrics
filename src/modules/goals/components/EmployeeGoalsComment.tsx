...
const EmployeeGoalsComment = ({ GOAL_ID, TASK_ID }: any) => {
  ...
  return (
    <div className="bg-white rounded-md space-y-6">
      ...
      <div className="space-y-3 h-[calc(100vh-340px)] overflow-y-auto">
        {comments.length > 0 ? (
...
export default EmployeeGoalsComment;
