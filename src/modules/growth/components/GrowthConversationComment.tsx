...
const GrowthConversationComment = ({ conversationId, discussionId }: any) => {
      ...
      <form onSubmit={formik.handleSubmit} className="mb-3">
        ...
        <div className="flex justify-end mt-2">
          <button
            ...
            className="text-sm text-white bg-gradient-to-b from-[#7E92F8] to-[#6972F0] px-3 py-2 !rounded-md flex flex-row gap-0.5 items-center text-center"
          >
          ...
          comments.map((comment: any) => (
            ...
            >
              <div
                ...
                className="w-[80%] border border-gray-200 rounded-md relative overflow-hidden"
              >
                <div
                  className={`${
                    comment?.commentedBy === EMP_ID
                      ? "bg-blue-50"
                      : "bg-green-50"
                  } flex justify-between items-center border-b-1 border-[#E8E8EC] p-2 overflow-hidden`}
                >
...
export default GrowthConversationComment;
